...
function ProductDialog(props) {
  ...
  const vechileModelOnChange = async (e) => {
    ...
    // const response = await axios.get(
    //   "http://localhost:8000/core/engine/list/?model=" + e.value
    // )
    // setDropdownEngineType(response.data)
  }

  // const EngineType = (e) => {
  //   setSelectedDropdownEngineType(e.value)
  //   axios.get("http://localhost:8000/core/engine/list/?engine=" + e.value)
  // }

  // const YearChanged=(e)=>{
  //         setSelectedDropdownYearStart
  // }
  ...
  const EditOrDeleteButton = (data) => {
    const EditButton = () => {
      axios
        .put(
          "http://localhost:8000/core/supported_vechile/{id}/delete/".replace("{id}", data.id),
          replace("{id}".data.id)
        )
        .then((res) => getSupportedVehicle)
    }
  ...
  return (
    <div className='dialog-demo'>
      <div className='card'>
        ...
        >
          <Column field='vechile_type' header='Araç Tipi'></Column>
          <Column field='trademark' header='Marka'></Column>
          <Column field='model' header='Model'></Column>
          <Column field='engine' header='Motor'></Column>
            ...
            <div className='col-4'>
              ...
              <div className='field '>
                ...
                <InputText
                  ...
                  onChange={(e) => setSelectedDropdownEngineType(e.target.value)}
                  optionLabel='name'
                  optionValue='id'
                />
              </div>
